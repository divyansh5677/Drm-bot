...
photozip = 'https://envs.sh/dVu.jpg/IMG20250813662.jpg'
...
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/@Divyanshshukla7"), InlineKeyboardButton(text="🛠️ Divyanshshukla", url="https://t.me/@Divyanshshukla7")],
    ]
)

# Image URLs for the random image feature
image_urls = [
    "https://envs.sh/dVu.jpg/IMG20250813662.jpg",
    "https://envs.sh/dVu.jpg/IMG20250813662.jpg",
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://envs.sh/dVu.jpg/IMG20250813662.jpg",
        caption=caption
    )
...
async def back_to_main_menu(client, callback_query):
    ...
    await callback_query.message.edit_media(
      InputMediaPhoto(
        media="https://envs.sh/dVu.jpg/IMG20250813662.jpg",
        caption=caption
      ),
...
async def help_button(client, callback_query):
  ...
  caption = (
        ...
        f"➥ /Ankit1 – Extract from .txt (Auto)\n"
...
def reset_and_set_commands():
    ...
    commands = [
        ...
        {"command": "Ankit1", "description": "📑 Upload .txt file"},
